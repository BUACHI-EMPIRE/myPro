...
class SMSApp {
    ...
    isValidPhoneNumber(phoneNumber) {
        ...
        // First try to clean the number to +233 format
        ...
        // Then validate against the Ghana pattern
        const ghanaPattern = /^\+233[2-5]\d{8}$/;
        return ghanaPattern.test(formattedNumber);
    }
...
window.SMSUtils = {
    ...
    validateGhanaNumber: function(phoneNumber) {
        ...
        // Validate against Ghana pattern
        return /^\+233[2-5]\d{8}$/.test(formattedNumber);
    }
};
